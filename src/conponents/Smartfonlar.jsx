    ...
    return (
        <div className="text-center text-black bg-slate-200 p-2">
            <section className="p-7">
                <h1 className="text-black mt-12  font-serif ">SMARTFONLAR_I</h1>
                    ...
                    <div className=" bg-white rounded-lg  shadow-md max-w-xs md:max-w-none overflow-hidden hover:opacity-95">
                        <NavLink to="/sm_1" style={{ textDecoration: "none" }}>
                            <img
                                ...
                                src="https://st5.depositphotos.com/82283920/67619/i/380/depositphotos_676190022-stock-photo-beautiful-mountain-landscape-snow-blue.jpg"
                                alt=""
                            />
